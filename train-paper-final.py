...
parser.add_argument('--output', default='model_paper.hdf5', type=str, 
                    help='Duong dan luu mo hinh')
parser.add_argument('--train_data', default='preprocess_128x128/train2', type=str, 
                    help='Duong dan den du lieu training')
parser.add_argument('--test_data', default='preprocess_128x128/test2', type=str, 
